...
public class Main {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println(mesaj.substring(6,10)); // 6 (dahil) dan başlar 10(dahil değil) a kadar alır		
		
	    System.out.println("-----------------------------------------------------------------");
	    
	    for(String kelime : mesaj.split(" ")) {  //split fonksiyonu bir dizi dönderir
	    	System.out.println(kelime);          //split fonksiyonu belirtilen ifalere gelince metni parçalar
	    }
	    
	    System.out.println(mesaj.toLowerCase()); //tüm harfler küçük olur
